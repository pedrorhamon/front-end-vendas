...
const routes: Routes = [
  ...
  { path: 'categoria', component: CategoriaComponent, canActivate: [authGuard], data: { roles: ['ADMIN_PRIVILEGE', 'READ_PRIVILEGE'] } },
  ...
  { path: 'pessoa', component: PessoaComponent, canActivate: [authGuard], data: { roles: ['ADMIN_PRIVILEGE', 'READ_PRIVILEGE'] }},
  ...
  { path: 'lancamento', component: LacamentoComponent, canActivate: [authGuard], data: { roles: ['ADMIN_PRIVILEGE', 'READ_PRIVILEGE'] } },
  ...
  { path: 'esqueci-senha', component: NovaSenhaComponent, canActivate: [authGuard],  data: { roles: ['ADMIN_PRIVILEGE', 'READ_PRIVILEGE'] }},
